...
function LevelComplete(e) {
    switch (e.value) {
        case "GameStarted": // Cuando el usuario presiona "Play" en el menú
            sendCommandToGame("LoadLevel", "forest_01.json");
            break;
            
        case "Level1Finished": // Cuando el juego detecta que terminó el 01
            // En lugar de ir al menú de niveles, le mandamos el 4
            sendCommandToGame("LoadLevel", "forest_04.json");
            break;
...
// Función para enviar comandos al juego dentro del WebView
function sendCommandToGame(command, data) {
    var webview = document.getElementById("webview");
    var script = "window.receiveCommand('" + command + "', '" + data + "');";
    webview.invokeScriptAsync("eval", script).start();
}